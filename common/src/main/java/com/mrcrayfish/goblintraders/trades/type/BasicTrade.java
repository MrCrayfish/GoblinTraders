...
public class BasicTrade implements ITradeType<GoblinTrade>
{
    ...
    public static class Serializer extends TradeSerializer<BasicTrade>
    {
        Serializer()
        {
            super(new ResourceLocation(Constants.MOD_ID, "basic"));
        }
        ...
        public BasicTrade deserialize(JsonObject object)
        {
            ...
            builder.setOfferStack(Services.PLATFORM.deserializeItem(GsonHelper.getAsJsonObject(object, "offer_item")));
            builder.setPaymentStack(Services.PLATFORM.deserializeItem(GsonHelper.getAsJsonObject(object, "payment_item")));
            if(GsonHelper.isValidNode(object, "secondary_payment_item"))
            {
                builder.setSecondaryPaymentStack(Services.PLATFORM.deserializeItem(GsonHelper.getAsJsonObject(object, "secondary_payment_item")));
            }
